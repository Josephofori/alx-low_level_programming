...
/**
 * create_buffer -  This is to allocates 1024 bytes for a buffer.
 *
 ...
 *
 * @argc: This is a number of arguments supplied to the program.
 *
